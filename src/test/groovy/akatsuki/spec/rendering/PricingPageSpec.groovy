...
class PricingPageSpec extends BaseSpecification {
  ...
  def "Pricing page renders correctly"() {
    ...
    'standardPricePanel'  | "Standard" | "£25/cert"  | "+ £75/apostille (optional)"   | ["Dispatch in 10 working days", "Email Tracking", "-"]
    'rapidPricePanel'     | "Rapid"    | "£40/cert"  | "+ £120/apostille (optional)"  | ["Dispatch in 5 working days", "Email Tracking", "SMS Tracking"]
    'primePricePanel'     | "Prime"    | "£60/cert"  | "+ £180/apostille (optional)"  | ["Dispatch in 1 working day", "Email Tracking", "SMS Tracking"]
  }
