...
class PricingPageSpec extends BaseSpecification {
  ...
  def "Pricing page renders correctly"() {
    ...
    'standardPricePanel'  | "Standard" | "£25/cert"  | "+ £75/apostille (optional)"   | ["Despatch in 10 working days", "Free delivery", "Support response in 48 hours", "Email Tracking", "-", "-"]
    'rapidPricePanel'     | "Rapid"    | "£40/cert"  | "+ £100/apostille (optional)"  | ["Despatch in 5 working days", "Free delivery", "Support response in 24 hours", "Email Tracking", "SMS Tracking", "-"]
    'primePricePanel'     | "Prime"    | "£60/cert"  | "+ £150/apostille (optional)"  | ["Despatch in 1 working day", "Free delivery", "Support response in 4 hours", "Email Tracking", "SMS Tracking", "Scan and email documents"]
  }
